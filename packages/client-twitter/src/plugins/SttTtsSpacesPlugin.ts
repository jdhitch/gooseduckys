...
import { Space } from "agent-twitter-client";
import { Plugin } from "@elizaos/core";

// Define both interfaces locally
interface AudioDataWithUser {
    userId: string;
    samples: Int16Array;
}

interface JanusClient {
    pushLocalAudio(frame: Int16Array, sampleRate: number, channels: number): void;
}
...
export class SttTtsPlugin implements Plugin {
    name = 'stt-tts';
    description = 'Speech-to-text and text-to-speech plugin for Spaces';
    private space?: Space;
